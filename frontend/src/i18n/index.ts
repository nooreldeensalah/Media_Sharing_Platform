...
const resources = {
  en: {
    translation: {
      ...
      "upload.maxSize":
        "Maximum file size: 50MB. Supported formats: JPEG, PNG, GIF, MP4, WebM",
  ...
  ar: {
    translation: {
      ...
      "media.deleteConfirm.message":
        "هل أنت متأكد من حذف هذا الملف الوسائطي؟ هذا الإجراء لا يمكن التراجع عنه.",
      ...
      "upload.maxSize":
        "الحد الأقصى لحجم الملف: 50 ميجابايت. الصيغ المدعومة: JPEG, PNG, GIF, MP4, WebM",
      "upload.images": "الصور",
